...
namespace SousChef2 {
    ...
    public partial class RecipeDataSet : global::System.Data.DataSet {
        ...
        public partial class RecipesDataTable : global::System.Data.TypedTableBase<RecipesRow> {
            ...
            private global::System.Data.DataColumn columnRecipes;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public global::System.Data.DataColumn RecipesColumn {
                get {
                    return this.columnRecipes;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public RecipesRow AddRecipesRow(string Recipes) {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            internal void InitVars() {
                this.columnRecipes = base.Columns["Recipes"];
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            private void InitClass() {
                this.columnRecipes = new global::System.Data.DataColumn("Recipes", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnRecipes);
                this.columnRecipes.AllowDBNull = false;
                this.columnRecipes.MaxLength = 50;
            }
        ...
        public partial class RecipesRow : global::System.Data.DataRow {
            ...
            public string Recipes {
                get {
                    return ((string)(this[this.tableRecipes.RecipesColumn]));
                }
                set {
                    this[this.tableRecipes.RecipesColumn] = value;
                }
            }
        }
...
namespace SousChef2.RecipeDataSetTableAdapters {
    ...
    public partial class RecipesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Recipes", "Recipes");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Recipes] ([Recipes]) VALUES (@Recipes)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Recipes", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Recipes", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Recipes FROM dbo.Recipes";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE  FROM [Recipes]\r\nWHERE        ([Recipes] = @Recipes)\r\n";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Recipes", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Recipes", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Recipes FROM [Recipes] ";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "INSERT INTO [dbo].[Recipes] ([Recipes]) VALUES (@Recipes)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Recipes", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Recipes", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(RecipeDataSet.RecipesDataTable dataTable) {
        ...
        public virtual RecipeDataSet.RecipesDataTable GetDataBy1() {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            RecipeDataSet.RecipesDataTable dataTable = new RecipeDataSet.RecipesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Insert(string Recipes) {
            if ((Recipes == null)) {
                throw new global::System.ArgumentNullException("Recipes");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(Recipes));
            }
        ...
        public virtual int DeleteQuery(string Recipes) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((Recipes == null)) {
                throw new global::System.ArgumentNullException("Recipes");
            }
            else {
                command.Parameters[0].Value = ((string)(Recipes));
            }
        ...
        public virtual int InsertQuery(string Recipes) {
